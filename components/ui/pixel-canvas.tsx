...
// Web component - lazily defined to avoid SSR issues
let PixelCanvasElement: typeof HTMLElement | null = null

function getPixelCanvasElement() {
  if (PixelCanvasElement) return PixelCanvasElement
  if (typeof window === "undefined") return null

  PixelCanvasElement = class extends HTMLElement {
  ...
  ({ gap, speed, colors, variant, noFocus, style, ...props }, ref) => {
    React.useEffect(() => {
      if (typeof window !== "undefined" && !customElements.get("pixel-canvas")) {
        const El = getPixelCanvasElement()
        if (El) customElements.define("pixel-canvas", El)
      }
    }, [])
